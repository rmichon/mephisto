...
oscParams.address[0] = "/osc0";
oscParams.address[1] = "/osc1";
oscParams.address[2] = "/osc2";
oscParams.address[3] = "/osc3";
oscParams.address[4] = "/osc4";
oscParams.minVal[0] = 0.0;
oscParams.minVal[1] = 0.0;
oscParams.minVal[2] = 0.0;
oscParams.minVal[3] = 0.0;
oscParams.minVal[4] = 0.0;
oscParams.maxVal[0] = 100.0;
oscParams.maxVal[1] = 100.0;
oscParams.maxVal[2] = 100.0;
oscParams.maxVal[3] = 100.0;
oscParams.maxVal[4] = 100.0;
oscParams.sensorsMinVal[0] = 0.0;
oscParams.sensorsMinVal[1] = 0.0;
oscParams.sensorsMinVal[2] = 0.0;
oscParams.sensorsMinVal[3] = 0.0;
oscParams.sensorsMinVal[4] = 0.0;
oscParams.sensorsMaxVal[0] = 1023.0;
oscParams.sensorsMaxVal[1] = 1023.0;
oscParams.sensorsMaxVal[2] = 1023.0;
oscParams.sensorsMaxVal[3] = 1023.0;
oscParams.sensorsMaxVal[4] = 1023.0;
oscParams.rate = 20;
oscParams.udp[0] = 192;
oscParams.udp[1] = 168;
oscParams.udp[2] = 178;
oscParams.udp[3] = 237;
oscParams.ssid = "CCRMA";
oscParams.pswd = "none";
